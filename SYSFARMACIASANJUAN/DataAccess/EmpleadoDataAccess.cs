    ...
    public class EmpleadoDataAccess
    {
        ...
        public void ModificarEmpleado(Empleado empleado)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                //command.Parameters.Add("@accion", SqlDbType.VarChar, 50).Value = empleado.accion;
                //command.Parameters["@accion"].Direction = ParameterDirection.InputOutput;
                //if (connection.State == ConnectionState.Open) connection.Close();
                //connection.Open();
                //command.ExecuteNonQuery();
                //accion = command.Parameters["@accion"].Value.ToString();
                //connection.Close();
                //return accion;
                ...
                //{
                //    // Manejar el error
                //    throw new Exception("Error al modificaar empleado: " + ex.Message);
                //}
            }
        }
    }
